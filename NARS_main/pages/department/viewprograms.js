        ...
        <>
            <div className="flex flex-row w-screen h-screen mt-2">
                <form
                    ...
                    className="bg-sky-200 h-screen w-[80%]  translate-x-[25%]  flex flex-col justify-center items-center text-black ml-1 rounded-2xl"
                >
                    
                    <div className="contentAddUser2 overflow-auto flex flex-col gap-10">
                        <div className="flex items-center justify-between">
                            <p className="font-bold text-3xl text-blue-900"> View Programs: </p>
                        </div>
