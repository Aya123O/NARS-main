...
export default function DepartmentAdminDashboard(cookies) {
    ...
    return (
        ...
        >
            <Link className="link2 text-gray-800 hover:text-slate-900 font-semibold " href="/profile">
                <span>
                    <CgProfile
            ...
            <button
                className="link2 text-gray-800 hover:text-slate-900 font-semibold text-left"
